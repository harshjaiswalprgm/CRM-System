...
const Sidebar = ({ onLogout }) => {
  return (
    <motion.aside
      ...
      className="w-64 h-screen bg-gradient-to-b from-blue-700 to-blue-900 text-white flex flex-col p-5 fixed"
    >
      <h2 className="text-2xl font-bold mb-10 text-center">Glow CRM</h2>
      <nav className="flex flex-col gap-6 text-lg">
        <button className="flex items-center gap-3 hover:text-blue-300">
